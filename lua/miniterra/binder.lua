--[[
	...
	Miniterra build system, C header generator and LuaJIT ffi binding generator.
...
Usage:
	...
	local lib = require'miniterra.binder'.lib
...
if not ... then require'miniterra.binder_test'; return end
